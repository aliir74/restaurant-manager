# Generated by Django 4.0.3 on 2022-04-10 08:38
import json
import os.path
...
class DoMigration:
    ...
    @staticmethod
    def fill_user_star_cnt(UserModel, ReviewModel):
        for user in UserModel.objects.all():
            user.stars_cnt = ReviewModel.objects.filter(user=user).count()
            user.save()
    ...
    def run(apps, schema_editor):
        ...
        DoMigration.fill_user_star_cnt(User, Review)
